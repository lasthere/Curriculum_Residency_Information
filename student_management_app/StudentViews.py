...
from student_management_app.models import CustomUser, Staffs, Courses, Subjects, Students, Grades, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult

def pages(request):
    student = Students.objects.get(admin=request.user.id)
    a = Subjects.objects.all()
    #grades = Grades.objects.filter(Grades=request.grades
    context={
        "a": a,
    }

    return render(request, "student_template/pages.html", context)
