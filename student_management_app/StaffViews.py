...
from student_management_app.models import CustomUser, Staffs, Courses, Subjects, Students, Grades, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
...
def staff_apply_leave(request):
    ...
    return render(request, "staff_template/staff_apply_leave_template.html")
