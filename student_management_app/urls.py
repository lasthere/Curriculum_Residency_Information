...
urlpatterns = [
    ...
    path('', views.pitlogin, name="login"),
    ...
    path('manage_student_no/', HodViews.manage_student_no, name="manage_student_no"),
    path('dlt_student/', HodViews.dlt_student, name="dlt_student"),
    path('contact_form/',HodViews.contact_form, name="contact_form"),
    ...
    # URSL for Student
    path('student_curriculum/', StudentViews.pages, name="pages"),
    ...
    path('student_residency/', StudentViews.student_residency, name="student_residency"),

    path('upload/csv/', HodViews.upload_csv, name='upload_csv'),
    path('upload-csv/', HodViews.profile_upload, name="profile_upload"),
    ]
